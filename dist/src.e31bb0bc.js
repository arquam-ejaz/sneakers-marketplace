...
var CONTRACT_NAME = 'sneakers-marketplace.aejaz.testnet';
...
},{"near-api-js":"../node_modules/near-api-js/lib/browser-index.js","./config":"config.js"}],"assets/1.png":[function(require,module,exports) {
...
var _2 = _interopRequireDefault(require("./assets/2.png"));

var _3 = _interopRequireDefault(require("./assets/3.png"));

var _4 = _interopRequireDefault(require("./assets/4.png"));

var _5 = _interopRequireDefault(require("./assets/5.png"));

var _6 = _interopRequireDefault(require("./assets/6.png"));
...
window.onload = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
  var a, prices, medias, containers, _loop, i, mintedNFTS, _i, title, tokenId, container, div, image, formButton;
  ...
  return regeneratorRuntime.wrap(function _callee2$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 11:
          prices = [99, 84, 77, 71, 65, 61];
          medias = ["https://link.storjshare.io/jxutk2refbbz5ffxbj55ekcf4tka/showcode-hackathon%2F1.png?wrap=0", "https://link.storjshare.io/jwxlflsc4xx3bmffgrg7j34h6mnq/showcode-hackathon%2F2.png?wrap=0", "https://link.storjshare.io/jxsaus3qtpck6aqgx2gdutv45zga/showcode-hackathon%2F3.png?wrap=0", "https://link.storjshare.io/jus34ztbnzwfpuqefzrvlekx2a7q/showcode-hackathon%2F4.png?wrap=0", "https://link.storjshare.io/jxpp22a2i3l7wid62ko5b53grafq/showcode-hackathon%2F5.png?wrap=0", "https://link.storjshare.io/jx5asdfe6eld64gvqj6w4c7yrwga/showcode-hackathon%2F6.png?wrap=0"];
          containers = document.getElementsByClassName('items-container');

          _loop = function _loop(i) {
            var container = containers[i <= 2 ? 0 : 1];
            ...
            var image = document.getElementById('image' + (i + 1).toString());
            image.src = images[i];
            var form = document.getElementById('form' + (i + 1).toString());
          ...
          return window.contract.nft_tokens_for_owner({
            account_id: window.accountId.toString()
          });

        case 18:
          mintedNFTS = _context2.sent;

          if (mintedNFTS.length != 0) {
            mintedNFTS.sort(function (a, b) {
              return a.token_id < b.token_id ? -1 : 1;
            });

            for (_i = 0; _i < mintedNFTS.length; _i++) {
              title = mintedNFTS[_i].metadata.title;
              tokenId = title.charAt(title.length - 1);
              container = containers[_i <= 2 ? 2 : 3];
              div = document.createElement('div');
              div.style = "margin-bottom:30px; margin-left: auto; margin-right: auto; border: 2.5px solid #ff585d; padding-bottom: 25px;";
              div.innerHTML = "<img id=\"imagec" + tokenId + "\" style = \"margin-top: 30px; width: 100%\"/>\n    <div>\n      <p style=\"font-weight: 500;\">\n        Sneaker #" + tokenId + "\n      </p>\n    </div>";
              container.appendChild(div);
              image = document.getElementById('imagec' + tokenId);
              image.src = images[parseInt(tokenId) - 1];
              formButton = document.getElementById('b' + tokenId);
...
},{"regenerator-runtime/runtime":"../node_modules/regenerator-runtime/runtime.js","./utils":"utils.js","near-api-js":"../node_modules/near-api-js/lib/browser-index.js","./assets/1.png":"assets/1.png","./assets/2.png":"assets/2.png","./assets/3.png":"assets/3.png","./assets/4.png":"assets/4.png","./assets/5.png":"assets/5.png","./assets/6.png":"assets/6.png","bn.js":"../node_modules/bn.js/lib/bn.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "32967" + '/');
